  ...
  return [
    {
      ...
      emoji: '🏰',
      description: '단선율 성가에서 다성음악과 초기 기보법으로 확장된 시대입니다.',
      characteristics: ['그레고리오 성가', '초기 다성음악', '교회선법', '기보법의 발달'],
    ...
    },
    {
      ...
      emoji: '🏛️',
      description: '성부 간 균형과 모방 대위법이 정교해지고 세속 성악곡이 발전한 시대입니다.',
      characteristics: ['모방 대위법', '성부 간 균형', '미사와 모테트', '세속 성악곡'],
